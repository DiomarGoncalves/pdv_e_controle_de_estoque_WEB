...
!function(a, b) {
    ...
    !function() {
        function b() {
            if (i) {
                i.https://diomarbr.github.io/pdv_e_controle_de_estoque_WEB/style.cssText = "box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%",
                i.innerHTML = "",
                qa.appendChild(h);
        ...
        h.https://diomarbr.github.io/pdv_e_controle_de_estoque_WEB/style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute",
        h.appendChild(i),
        r.extend(o, {
